...
const NiuniuDefault: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className={`flex flex-col items-center min-h-screen gap-4 md:gap-16 py-16 hash-game-container mx-auto ${isCollapsed ? 'sidebar-collapsed' : ''}`}>
            ...
            >
              ...
              />
                            ...
                            <div onClick={handleMenuClick} className="flex h-9 w-9 justify-center items-center rounded-lg border border-white/[0.04] bg-white/[0.04] shadow-[inset_0_1px_0_rgba(255,255,255,0.16)] backdrop-blur-[32px]">
