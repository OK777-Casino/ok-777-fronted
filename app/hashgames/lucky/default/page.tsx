...
const NiuniuDefault: React.FC = () => {
  ...
  return (
    <>
      <div
        className={`flex flex-col items-center min-h-screen gap-4 md:gap-16 py-16  mx-auto ${
        ...
        <div className="w-full flex flex-col items-center gap-4 p-0 ">
          <div className=" justify-between  w-full items-center mb-8 bg-[#222d3d] pr-4 rounded-lg flex  [@media(max-width:768px)]:hidden">
            ...
            <div className="flex items-center gap-4">
              ...
              <div
                ...
                className="flex h-9 w-9 justify-center items-center rounded-lg border border-white/[0.04] bg-white/[0.04] shadow-[inset_0_1px_0_rgba(255,255,255,0.16)] backdrop-blur-[32px]"
              >
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center w-full gap-2 sm:gap-0">
            ...
            <div className="flex h-6 items-center gap-2">
              <span className="text-xs sm:text-sm font-bold text-casper">
                Beginner
              </span>
