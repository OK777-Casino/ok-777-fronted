...
const BankerPlayerDefault: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className={`flex flex-col items-center min-h-screen  gap-4 md:gap-16 py-16 px-0 hash-game-container mx-auto ${isCollapsed ? 'sidebar-collapsed' : ''}`}>
      ...
      <div className="bg-[#72707038] rounded-lg w-full  p-1 hidden [@media(max-width:768px)]:flex ">
        <Link
            href="/hashgames/bankerplayer/active"
          className={` w-[50%] justify-center flex justify-center items-center  py-1.5 rounded-lg font-bold text-white transition-all duration-200 text-[14px] border-none flex items-center gap-2 hover:bg-[rgba(255,255,255,0.08)]`}
        >
          {" "}
          <img
            src="/icons/swap-horizontal.svg"
