...
const BankerPlayerActive: React.FC = () => {
  ...
  return (
    <>
      <div className={`w-full hash-game-container px-4 lg:px-0 py-16 mx-auto ${isCollapsed ? 'sidebar-collapsed' : ''}`}>
          {/* Header Section */}
      ...
      <div className="bg-[#111923] rounded-lg p-3 mb-6  border border-[rgba(12,96,255,0.1)] shadow-xl [@media(max-width:768px)]:block hidden">
        ...
        <CopyBox className="w-full mb-4"><span className="text-[#2283F6]">TXS3</span>PfAUShemKkoBWRUFsUkGBSrZ<span className="text-[#2283F6]">gh..</span></CopyBox>
