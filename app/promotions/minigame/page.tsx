...
const MiniGamePage = () => {
    ...
    const data = {
        heading: "Mini Game: Time and Space Adventure",
        title: {
            line1: "crypto game",
            line2: "time-space quest"
        },
        background: "bg-[url('/images/banner/Banner04-1.jpg')]",
        submit: "get $1588",
        onClick: clickSubmit,
        button: "Go to bet",
    ...
    return (
        <BetTemplate {...data} >
            <div className="p-4 grid grid-cols-1  2xl:grid-cols-2 rounded-[12px] mb-8 bg-white-4 gap-4">
                {
