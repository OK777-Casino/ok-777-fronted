        ...
        <BetTemplate {...data} >
            ...
            <div className="flex flex-col 2xl:flex-row gap-4">
                <div className="2xl:p-8 p-4 w-full rounded-[12px] overflow-hidden bg-white-4 flex items-center flex-col gap-4">
                    <span className="text-white font-bold text-[22px]">Amount Per Bet <span className="text-yellow-orange">≥50U</span></span>
                    <span className="text-casper text-[14px]">Award Tron Energy</span>
                </div>
                <div className="2xl:p-8 p-4  w-full rounded-[12px] overflow-hidden bg-white-4 flex items-center flex-col gap-4">
                    <span className="text-white font-bold text-[22px]"><span className="text-yellow-orange">≥50U </span> Free with every bet </span>
                    <span className="text-casper text-[14px]">Award Tron Energy</span>
                </div>
            </div>
              ...
              <div className="grid xl:grid-cols-2 lg:grid-cols-1 gap-4">
                <div className="p-8 flex flex-col gap-8  bg-white-4 rounded-[12px]">
                  <div>
                    ...
                    <span className="text-[14px] text-casper font-bold pt-4">
                        Place a single ≥50 bet in the game. 
                        The system automatically gives energy to 
                        offset the miner's fee required for the next transaction
                    </span>
                  </div>
                ...
                <div className="p-8 flex flex-col items-start gap-4 bg-white-4 rounded-[12px]">
                    ...
                    <span className="text-[14px] text-casper font-bold">
                        When there is energy in the account, the next transfer automatically reduces the fee
                    </span>
                    <div className="flex justify-center items-center flex items-center justify-center w-full relative">
                      <img src="/images/Device6.png" className="h-[225px]" alt="phone" />
                      <div className="flex w-[255px] absolute top-1/2 left-1/2 transform translate-y-1/2 -translate-x-1/2">
                        <div className="w-full h-[49px] rounded-[16px] border-l-[3px] border-t-[1px] shadow-[0_8px_16px_#3389FF40] bg-mirage flex items-center justify-center text-casper text-[14px] font-bold border-t-casper border-l-malachite">Fee exemption</div>
                        <img src="/images/percent.png" alt="percent" className="w-[84.85px] ml-[-15px] h-[84.85px]" />
                      </div>
                    </div>
                </div>
              </div>
