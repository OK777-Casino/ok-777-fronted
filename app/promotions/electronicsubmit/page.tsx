    ...
    return (
        <BetTemplate {...data} >
          <div className="p-4 flex flex-col gap-4 items-center bg-white-4 rounded-[12px] mb-4">
            <span className="text-white font-bold text-[18px]">Promotion Details</span>
            <p className="text-[14px] font-medium flex justify-center items-center w-[75%] mx-auto text-casper">
              [OK777 Hash Casino]VIP Bet (Slot Games) Place bets reaching <span className="text-yellow-orange">200 USDT+</span> to 
              receive challenge bonuses. Pass the levels to <span className="text-yellow-orange">win up to 1588 USDT</span> in bonuses! 
              Join now! Generous bonuses await you!
            </p>
          </div>
