        ...
        <BetTemplate {...data} >
            <div className="p-4 bg-white-4 rounded-[12px] flex flex-col gap-4">
              ...
              <div className="p-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 rounded-[12px] bg-white-4 gap-4">
                <TXCard title="First single transaction≥50U" fee="20%" value="20" desc={<>HighestGift Turnover Multiple <b className="text-white">10</b></>} />
                <TXCard title="First single transaction≥50U" fee="30%" value="150" desc={<>HighestGift Turnover Multiple <b className="text-white">15</b></>} />
                <TXCard title="First single transaction≥50U" fee="50%" value="1000" desc={<>HighestGift Turnover Multiple <b className="text-white">22</b></>} />
                <TXCard title="First single transaction≥50U" fee="100%" value="20000" desc={<>HighestGift Turnover Multiple <b className="text-white">35</b></>} />
