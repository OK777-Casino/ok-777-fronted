...
const VipClubPage = () => {
    ...
    return (
        <div className="w-full hash-game-container mx-auto flex flex-col p-4 gap-8">
            <div className="bg-[linear-gradient(#003F70,#0078D6)] relative overflow-hidden rounded-[0.75rem] border-[0.0625rem] border-white-13 gap-6 py-8 px-6 flex items-center" >
                <img src="/images/awards/Silver.svg" className="h-[7.25rem] lg:block hidden" alt="Silver" />
                <div className="flex flex-col gap-6 w-full">
                    <div className="flex items-between gap-4">
                            <div className="lg:hidden w-full justify-center flex">
                            <img src="/images/awards/Silver.svg" className="h-[7.25rem] " alt="Silver" />

                            </div>

                            <div className="w-full flex flex-col justify-center ">
                                <span className="text-casper text-[0.75rem] font-medium block">Silver</span>
                                <span className="bg-[linear-gradient(#686150,#CFC8B5,#696150)] block text-[1.5rem] font-bold bg-clip-text text-transparent">VIP 4</span>
                                <span className="lg:hidden font-medium text-[0.75rem] text-white flex items-center cursor-pointer" onClick={() => setIsModalOpen(true)}>Upgrade details <ChevronRightIcon className="w-6 h-6" /></span>
                            </div>
                    </div>
                    <div className="flex gap-6 w-full">
                        <div className="flex flex-col gap-2 w-full">
                            <span className="font-bold text-[0.875rem] text-white">Current deposits</span>
                            <div className="bg-white-4 rounded-full h-[0.375rem]">
                                <div className="w-[10%] bg-french-rose h-full rounded-full" />
                            </div>
                            <span className="text-white text-[0.875rem] font-bold"><span className="text-yellow-orange">25$</span> / 100$</span>
                        </div>
                        <div className="flex flex-col gap-2 w-full">
                            <span className="font-bold text-[14px] text-white">Current incomes</span>
                            <div className="bg-white-4 rounded-full h-[6px]">
                                <div className="w-[10%] bg-french-rose h-full rounded-full" />
                            </div>
                            <span className="text-white text-[14px] font-bold"><span className="text-yellow-orange">25$</span> / 800$</span>
                        </div>
                    </div>
                </div>
                <img src="/images/awards/badge.png" className="absolute opacity-20  -right-5 -top-8 h-[105%] lg:h-[140%]" alt="badge" />
            </div>
            <div>
                    ...
                    <SwiperSlider
                        ...
                        renderSlide={(manufacturer, index) => (
                            <div className="rounded-[12px] overflow-hidden p-4 bg-white-4 hover:bg-white-8 flex flex-col gap-3">
                                <div className="flex gap-4 items-start" onClick={() => setIsModalOpen(true)}>
                                    <img src="/images/awards/Bronze.svg" className="h-10" alt="bronze" />
                                    <div>
                                        <div className="flex gap-2">
                                            <span className="uppercase font-bold text-[14px] text-white">vip</span>
                                            <span className="font-bold text-[14px] text-dodger-blue">1-3</span>

                                        </div>
                                        <span className="text-casper font-medium text-[14px]">Bronze</span>
                                    </div>
                                ...
                                <div className="rounded-[12px] hover:bg-white-8 p-4 bg-white-4 relative flex gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="text-[12px] font-bold text-white">Discount rate</span>
                                ...
                                <div className="rounded-[12px] hover:bg-white-8 p-4 bg-white-4 relative flex gap-4">
                                    <img src="/images/awards/image-1.svg" className="h-10" alt="" />
                                    <div className="flex flex-col">
                                        <span className="text-[12px] font-bold text-white">Discount rate</span>
                                        <span className="text-[14px] text-casper">0.20%-0.40%</span>
                                    </div>
                                ...
                                <div className="rounded-[12px] hover:bg-white-8 p-4 bg-white-4 relative flex gap-4">
                                    <img src="/images/awards/image-2.svg" className="h-10" alt="" />
                                    <div className="flex flex-col">
                                        <span className="text-[12px] font-bold text-white">Discount rate</span>
                                        <span className="text-[14px] text-casper">0.20%-0.40%</span>
                                    </div>
                                ...
                                <div className="rounded-[12px] hover:bg-white-8 p-4 bg-white-4 relative flex gap-4">
                                    <img src="/images/awards/image-3.svg" className="h-10" alt="" />
                                    <div className="flex flex-col">
                                        <span className="text-[12px] font-bold text-white">Free withdrawal</span>
                                        <span className="text-[14px] text-casper">The first <b className="text-malachite">3</b> times free</span>
                                    </div>
                                    <InfoCircleIcon className="w-6 h-6 text-blue-bayoux hover:text-polo-blue absolute top-1 right-1" />
            ...
            <div className="rounded-[12px] 2xl:h-[292.9px] 2xl:overflow-hidden  relative bg-center bg-cover">
                <img src="/images/block-coin.png" className="w-full absolute 2xl:block hidden h-full z-[9] object-cover grayscale" />
                ...
                <div className="relative w-full h-full flex-col lg:flex-row 2xl:p-8 gap-8 z-[99] items-center flex justify-between">
                    <div className="flex flex-col 2xl:w-[250px] gap-2 2xl:bg-mirage bg-white-4 p-4 rounded-[12px]">
                        <span className="text-[14px] font-bold text-white">The relationship is still there!</span>
                        <p className="text-casper text-[14px]">
                            Stay tuned for special offers and the latest news. 
                            If you have any questions, please contact our 
                            customer service team.
                        </p>
                    </div>
                    <img src="/images/headset.png" alt="headset" className="hidden 2xl:block w-[246px]" />
                    <div className="flex flex-col gap-px rounded-[8px] w-full 2xl:w-[330px] overflow-hidden">
                        <div className=" h-12 2xl:bg-mirage bg-white-4 flex items-center p-3 justify-between">
                            <div className="flex gap-2">
                                ...
                                <span className="text-casper font-bold text-[14px]">24/7 online customer service</span>
                            </div>
                        ...
                        <div className=" h-12 2xl:bg-mirage bg-white-4 flex items-center p-3 justify-between">
                            <div className="flex gap-2">
                                ...
                                <span className="text-casper font-bold text-[14px]">Telegram</span>
                            </div>
                            <ArrowUpRightStrokeIcon className="w-6 h-6 text-casper" />
                        </div>
                        <div className=" h-12 2xl:bg-mirage bg-white-4 flex items-center p-3 justify-between">
                           <div className="flex gap-2">
                            ...
                            <span className="text-casper font-bold text-[14px]">WhatsApp Customer Service</span>
                           </div>
                            <ArrowUpRightStrokeIcon className="w-6 h-6 text-casper" />
                        </div>
            ...
            <div className="flex flex-col gap-4">
                <span className="text-white font-bold text-[18px]">Questions to be answered</span>
                <div className="flex flex-col 2xl:flex-row gap-4">
                    <FAQ faqs={faq} title={false} />
                    <FAQ faqs={faq1} title={false} />
                </div>
            </div>
            <ModalContainer title="VIP system level" isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
                <div className="flex gap-4 flex-col">
                            ...
                            vips[1].map((vip, index) => 
                                <div className="grid px-4 items-center bg-white-4 flex justify-center items-center font-bold text-[14px] rounded-[8px] h-10 text-white grid-cols-[auto_100px_90px_80px] gap-2" >
                                    <span className="flex gap-2 items-center">
                                        <img src="/images/awards/Bronze.svg" alt="bronze" className="w-6 h-6" />
                    ...
                    <div className="py-4 flex flex-col gap-2  text-[14px]">
                        <span className="font-bold text-white">VIP promotion requirements</span>
                        <span className="text-casper">For users betting with TRX, the system will convert it at the rate of <span className="text-dodger-blue font-bold">1U=25TRX.</span></span>
                    </div>
                    <div className="flex w-full flex-col gap-[6px]">
                        <div className="grid px-4 items-center bg-mirage-8a flex justify-center items-center font-bold text-[12px] rounded-t-[8px] h-10 text-blue-bayoux grid-cols-[auto_100px_90px_80px] gap-2">
                            <span>VIP level</span>
