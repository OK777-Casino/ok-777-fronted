      ...
      <div className="flex flex-col p-2 2xl:gap-16 gap-4">
        ...
        <div className="flex flex-col gap-4 p-4" id="Refund">
          ...
          <p className="text-[14px] text-white">
            ...
            created by your transaction is used to determine the winning result.
            Ignore any letters and decimal points in the hash.
          </p>
          <p className="text-[14px] text-white">
          ...
          <p className="text-[14px] text-white">
            ...
            bet amount is 0. According to the rules, since 0 is in the range of
            0 to 4, your bet is a 'small' bet.
          </p>
          <p className="text-[14px] text-white">
            6. Example of a large bet: If you bet 1009 USDT, the last digit of
            your bet amount is 9. Since 9 is in the range of 5 to 9, your bet is
            a 'large' bet.
          </p>
        </div>
      </div>
