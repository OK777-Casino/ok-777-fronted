...
export const OverlayProvider: React.FC<OverlayProviderProps> = ({ children }) => {
  ...
  // State getters
  const isHashHoverOpen = overlayState.type === 'hash-hover' && overlayState.isOpen;
  const isNotificationsOpen = overlayState.type === 'notifications' && overlayState.isOpen;
  ...
  const ProfileOverlay = dynamic(() => import('@/components/overlays/ProfileOverlay'), { ssr: false });
  ...
  return (
    <OverlayContext.Provider value={value}>
      ...
      {isHashHoverOpen && <HashHoverLayer data={overlayState.data} onClose={closeOverlay} />}
