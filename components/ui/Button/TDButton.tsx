...
const TDButton: React.FC<TDButtonProps> = ({
  ...
  const redStyle = `
    bg-[linear-gradient(1turn,var(--button-red-start)_0.8%,var(--button-red-end))]
    ...
    `
  const blueStyle = `
    bg-[linear-gradient(1turn,var(--button-blue-start)_0.8%,var(--button-blue-end))]
  ...
  const edge = type === 'red' ? 'bg-button-red-edge' : 'bg-[#2283F680]'
