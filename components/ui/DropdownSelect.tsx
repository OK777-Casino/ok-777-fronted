          ...
          <div className="flex flex-col justify-center items-start flex-1 min-w-0">
            {
              ...
              <div
                ...
                style={{ color: '#93ACD3', fontFamily: 'Montserrat, -apple-system, Roboto, Helvetica, sans-serif' }}
              >
                {label}
              </div>
              ) 
            ...
            <div
              ...
              style={{ color: '#A7B5CA', fontFamily: 'Montserrat, -apple-system, Roboto, Helvetica, sans-serif' }}
            >
              {displayLabel}
            </div>
          </div>

          <ChevronDownIcon className={cn("text-casper", isOpen ? "rotate-180": "")} />
        </div>
      </div>
