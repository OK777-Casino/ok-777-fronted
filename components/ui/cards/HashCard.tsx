      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="flex justify-between items-center mb-2 sm:mb-3">
          <div className="flex items-center gap-1 sm:gap-2 min-w-0 flex-1">
            <h1 className="text-[12px] sm:text-[14px] font-bold text-white truncate">{title}</h1>
          ...
          <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
            <span className="text-gray-300 text-[9px] sm:text-[11px]">Chances:</span>
            <span className="text-red-400 text-[11px] sm:text-[13px] font-bold bg-red-500/20 px-1 py-0.5 sm:px-1.5 sm:py-1 rounded">
              {chances}
            </span>
          </div>
        </div>
        ...
        <div className="flex gap-1.5 sm:gap-2 mt-auto">
          <Button variant="green" className="flex-1 min-h-[28px] sm:min-h-[32px]">
            <Link className="flex items-center justify-center gap-1 sm:gap-1.5" href={leftButtonLink}>
              <ArrowLeftRight className="w-2 h-2 sm:w-2.5 sm:h-2.5" />
              <span className="text-[9px] sm:text-[11px] font-medium">Junior field</span>
            </Link>
          </Button>
          <Button variant="blue" className="flex-1 min-h-[28px] sm:min-h-[32px]">
