...
export default function CasinoPromotionCard({ button, image, link}: { button: string, image: string, link: string}) {
  return (
    <div className="">
      {/* Card Container */}
      <div className="flex flex-col w-[21.166875rem] bg-mirage-1-2 rounded-xl overflow-hidden shadow-lg">
        ...
        <div
      className="group relative overflow-hidden rounded-t-[0.875rem] h-[11.75rem] w-full px-6 py-8 text-white shadow-md transition-all duration-300 "
    >
        ...
        <div className="p-4 bg-mirage-2 rounded-b-xl">
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between">
              ...
              {/* Casino Badge */}
              <TabButton type='one' title='Casino' className='h-[1.25rem] w-[3.6875rem] text-[0.75rem]' />
            </div>
          ...
          <div className="mt-3 text-right">
            <Link href={"/promotions/"+link} className="inline-flex items-center gap-2 text-dodger-blue font-montserrat text-[0.875rem] font-bold hover:text-dodger-blue/80 transition-colors group">
              Read more
