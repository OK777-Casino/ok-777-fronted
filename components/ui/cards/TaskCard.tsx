        ...
        <div className="rounded-[12px] overflow-hidden">
                    ...
                    <div className="p-4 bg-white-4">
                        <div className="flex justify-between items-center">
                            <div className="flex gap-4">
                                ...
                                <div className="font-bold text-white">
                                    <span className="block"><span>Cumulative valid bets on the day</span></span>
                                    <span className="block uppercase"><span><span className="text-yellow-orange"><>{price}</></span>usdt</span></span>
                                </div>
                            </div>
                        ...
                        <div className="flex pt-4">
                            ...
                            <div className="text-dodger-blue font-bold flex justify-center items-center text-[10px] w-8">1U</div>
                        </div>
                    </div>
