...
const DiceGameCard: React.FC<DiceGameCardProps> = ({
  ...
  return (
    <Link href={link} className="block">
      <div className={`${getColorClasses(color)} rounded-lg p-4 h-24 flex flex-col justify-center items-center hover:scale-105 transition-transform duration-200 cursor-pointer`}>
