...
export default function LayoutContent({ children }: LayoutContentProps) {
  ...
  return (
    <>
      <Suspense fallback={<div><span>Loading header...</span></div>}>
      ...
      <main className={`w-full ${isMobileHeader ? 'pt-[56px] sm:pt-[64px]' : 'pt-[56px]'} relative z-60 transition-all duration-300`}>
        <div className="w-full max-w-[100vw] min-h-[calc(100vh-56px)]">
          ...
          {isNotificationsOpen && !isMobileHeader && (
            <div className={`hidden lg:flex w-[420px] h-[calc(100vh-56px-59px)] lg:h-[calc(100vh-56px)] bg-[#0f141c] border-l border-gray-700 flex-shrink-0 fixed right-0 top-[56px] z-[60]`}>
