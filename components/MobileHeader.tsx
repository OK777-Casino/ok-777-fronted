...
export function MobileHeader({ title, onBackClick, onSupportClick, className, showBackButton = true, isHeadSet }: MobileHeaderProps) {
  const { t } = useI18n();
  ...
  return (
    <div className={cn(
      ...
      <h1 className={cn(
        ...
        showBackButton ? "flex justify-center items-center sm:text-left" : "flex justify-center items-center",
