    ...
    switch (activeTab) {
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="bg-[#ffffff0a] p-4 rounded-xl">
              <h3 className="text-lg font-bold text-white mb-3">{t('rules.valueRules')}</h3>
              <div className="text-sm text-white space-y-2 leading-relaxed">
                <p>
                  <span>The game uses <span className="text-cyan-400">TRX</span> blockchain's{' '}
                  <span className="text-cyan-400">block hash</span> as the random number source.{' '}
                  <span className="text-cyan-400">(ignoring letters)</span></span>
                </p>
                <p>
                  <span>Each block hash is a 64-character hexadecimal string. We extract the last 8 characters{' '}
                  <span className="text-cyan-400">(ignoring letters)</span> and convert them to decimal numbers.</span>
                </p>
              </div>
            </div>
            ...
            {/* Wallet A section */}
            <div className="bg-[#ffffff0a] p-4 rounded-xl">
              <h3 className="text-lg font-bold text-white mb-3"><span>Wallet A</span></h3>
              ...
              <span className="text-xs font-bold"><span>Query</span></span>
            </UnifiedButton>
              </div>
            </div>
            ...
            {/* Wallet B section */}
            <div className="bg-[#ffffff0a] p-4 rounded-xl">
              <h3 className="text-lg font-bold text-white mb-3"><span>Wallet B</span></h3>
              <div className="flex gap-3">
                <input
                  type="text"
                  value="TP4KGac4W7oKYuXgfUcZVm7..."
            ...
            {/* Game rules section */}
            <div className="bg-[#ffffff0a] p-4 rounded-xl">
              <h3 className="text-lg font-bold text-white mb-3"><span>Game rules</span></h3>
              <div className="text-sm text-white space-y-2 leading-relaxed">
                <p>
                  <span>The game uses <span className="text-cyan-400">TRX</span> blockchain's{' '}
                  <span className="text-cyan-400">block hash</span> as the random number source.{' '}
            ...
            <div className="bg-[#ffffff0a] p-4 rounded-xl">
              <h3 className="text-lg font-bold text-white mb-3"><span>Rules of the game</span></h3>
            ...
            <div className="bg-[#ffffff0a] p-4 rounded-xl">
              <h3 className="text-lg font-bold text-white mb-3"><span>Things to note</span></h3>
              <div className="text-sm text-white space-y-2">
                <div className="flex gap-2">
                  <span className="text-cyan-400 font-medium">1.</span>
                  <p>
      ...
      case 'hash-odd-even':
        return (
          <div className="space-y-6">
            <div className="bg-[#ffffff0a] p-4 rounded-xl">
              <h3 className="text-lg font-bold text-white mb-3"><span>Hash Odd and Even Rules</span></h3>
              <div className="text-sm text-white space-y-2 leading-relaxed">
                <p>
      ...
      case 'lucky-hash':
        return (
          <div className="space-y-6">
            <div className="bg-[#ffffff0a] p-4 rounded-xl">
              <h3 className="text-lg font-bold text-white mb-3"><span>Lucky Hash Rules</span></h3>
              <div className="text-sm text-white space-y-2 leading-relaxed">
                <p>
