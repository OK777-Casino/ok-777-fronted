    ...
    <div className=" [@media(max-width:660px)]:w-full">
      <div className="w-full flex flex-col gap-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4 bg-white-4 rounded-[12px] overflow-hidden p-1 h-11">
          {
            ["Crypto", "Fiat"].map((item, index) => <div className={cn("text-[14px] font-bold rounded-[8px] overflow-hidden flex justify-center items-center", selectedCurrencyType === item ? "bg-white-13 text-gallery" : "text-casper")} onClick={() => handleCurrencyTypeClick(item)}>{item}</div>)
          }
        </div>
            ...
            <>
              ...
              <div className="p-4 grid grid-cols-[141px_auto] gap-4 rounded-[12px] bg-white-4">
                <div className="bg-white rounded-[8px] p-2 ">
                  <img src="images/qr.png" className="h-[125px] aspect-[1/1]" alt="qr" />
                </div>
