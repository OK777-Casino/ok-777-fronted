          ...
          <>
            ...
            <div className="p-4 flex gap-4 rounded-[0.75rem] bg-white-4 flex-col">
              ...
              <CopyBox className="bg-white-8">
                <span className="text-casper font-bold break-all p-4 text-[0.75rem]">
            ...
            <div className="p-4 flex gap-4 rounded-[0.75rem] bg-white-4 flex-col">
              ...
              <div className="grid grid-cols-4 h-[47px] items-center  gap-4 font-bold text-[0.75rem]">
                <div className=" text-casper text-[0.75rem] font-bold h-full flex items-center justify-center  bg-white-8 rounded-[0.5rem]">
                  Lowest
                </div>
                <div className=" text-casper text-[0.75rem] font-bold h-full flex items-center justify-center  bg-white-8 rounded-[0.5rem]">
                  25%
            ...
            <div className="">
              ...
              <div className="flex justify-between py-2 items-center">
                <span className="text-casper font-medium text-[0.75rem] flex items-center gap-1">
                  Handing fee: <InfoCircleIcon className="w-6 h-6" />
                </span>
