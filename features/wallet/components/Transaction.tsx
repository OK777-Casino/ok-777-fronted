    ...
    <div className=" [@media(max-width:660px)]:w-full flex flex-col gap-4">
      ...
      <div>
        <div className="grid h-[56px] border-b flex justify-center items-center   border-ebony-clay items-center grid-cols-4 gap-4 py-2 px-4 rounded-t-[8px] bg-mirage text-blue-bayoux text-[12px] font-bold">
          ...
          <span className="word-break flex justify-center items-center">Quantity</span>
          <span className="word-break flex justify-center items-center">State</span>
        </div>
        <div className="flex flex-col rounded-[8px] overflow-hidden">
          {
            history.map((item, index) => 
              <div key={index}  className={cn("grid text-[12px] h-12 items-center grid-cols-4 gap-4 py-2 px-4 font-bold", index % 2 === 0 ? "bg-white-4": "bg-white-8")}>
                <span className="text-white flex justify-center items-center font-bold ">{item.time}</span>
                <span className="text-white flex justify-center items-center font-medium ">{item.type}</span>
