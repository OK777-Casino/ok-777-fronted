import { SidebarItem, SidebarSection, TopButton, PaymentMethod, AppDownload } from '@/components/sidebar-data';
...
export const createSidebarData = (t: (key: string) => string) => {
  ...
  const languageData = {
    ...
    "pt-br": { name: t('languages.portugueseBR'), flag: "/icons/flag-icon/br.svg" },
